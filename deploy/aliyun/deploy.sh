...
PDK_MEDIAMTX_HOST="${PDK_MEDIAMTX_HOST:-}"
PDK_MEDIAMTX_NODE_CODE="${PDK_MEDIAMTX_NODE_CODE:-mediamtx-remote-1}"
PDK_MEDIAMTX_NODE_NAME="${PDK_MEDIAMTX_NODE_NAME:-}"
PDK_MEDIAMTX_PUBLIC_RTMP="${PDK_MEDIAMTX_PUBLIC_RTMP:-}"
PDK_MEDIAMTX_PUBLIC_HLS="${PDK_MEDIAMTX_PUBLIC_HLS:-}"
PDK_MEDIAMTX_INTERNAL_API="${PDK_MEDIAMTX_INTERNAL_API:-}"
PDK_MEDIAMTX_INTERNAL_METRICS="${PDK_MEDIAMTX_INTERNAL_METRICS:-}"
PDK_MEDIAMTX_INTERNAL_SERVICE_TOKEN="${PDK_MEDIAMTX_INTERNAL_SERVICE_TOKEN:-}"
